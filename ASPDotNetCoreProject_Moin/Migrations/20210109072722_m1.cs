        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AuthorNumber = table.Column<string>(maxLength: 12, nullable: true),
                    ...
                    ISBCode = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    Price = table.Column<int>(nullable: false),
                    PublishingDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksInfos", x => x.BookId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookImage = table.Column<byte[]>(type: "image", nullable: true),
